...
class MUIDataTable extends React.Component {
  ...
  validateOptions(options) {
    ...
    if (this.props.options.filterList) {
      console.error(
        'Deprecated: filterList must now be provided under each column option. see https://github.com/gregnb/mui-datatable/tree/master/examples/column-filters example',
      );
    }
  }
